...
import { rtl_scss } from "./gulp/tasks/rtl-scss.js";
...
function watcher() {
    ...
    gulp.watch(path.watch.rtl_scss, rtl_scss);
...
//основные задачи
const mainTasks = gulp.series(fonts, gulp.parallel(copy, libs, html, scss, rtl_scss, js, images));
